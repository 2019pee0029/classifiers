...
##################################################
# Step 1
# Create 3 plots to select best lag in time series data
##################################################
...
def cv_experts(ts, lag = 20, gating = 'linear', pdir = ''):
    ...
    Plot the number of experts vs likelihood
     ...
     Input
        ts:         time series data
        lag:        time lag used to build the (x, y) data
    ...
    #------------------------------------------
    # 1. Convert time series to  (X, Y) data
    #------------------------------------------
...
def final_ME(ts, m, lag = 20, gating = 'linear', pdir = ''):
    ...
    # 1. Create (X, Y) data
    #------------------------------------------
    # Convert time series in (X, Y) data
