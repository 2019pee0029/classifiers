...
class svm:
    ...
    def multi_svm(self, X_train, y_train, X_test, y_test, DS_name, results, tune=True, plot = False, pdir = ''):
        # Input
        # DS_name: data name, e.g. 'Diabetes'
...
if __name__ == '__main__':
    ...
    if binary:
        results = fit.multi_svm(X_train, y_train, X_test, y_test, DS_name = 'Test data',
                      results = results, tune = True, plot = True, pdir = '')
    else:
        results = fit.multi_mc(X_train, y_train, X_test, y_test, DS_name = 'Test data',
                        results = results, tune = True, plot = True, pdir = '')
